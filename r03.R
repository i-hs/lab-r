...
# 때로는 콜론(:) 또는 탭(\t) 등으로 데이터를 구분하는 경우도 있음
getwd()  # get working directory: 현재 작업 디렉토리 이름을 반환
setwd("C:/dev/lab-r")  # set working directory: 현재 작업 디렉토리 변경
...
# (예) 현재 작업 디렉토리가 C:/dev/lab-r인 경우에,
#   상대 경로 - data/csv_exam.csv
#   절대 경로 - C:/dev/lab-r/data/csv_exam.csv
# 상대 경로에서 .은 현재 디렉토리를 의미, ..은 상위 디렉토리를 의미
#   data/test.csv와 ./data/test.csv는 같은 의미
#   ../r01.R (C:/dev/r01.R)
