...
# 열(colmun): 모든 문서에서 추출한 단어들
sms_dtm <- DocumentTermMatrix(sms_corpus_clean)
str(sms_dtm)

# DTM를 사용해서 학습 데이터 세트(75%)와 
# 테스트 데이터 세트(25%)로 나눔
sms_dtm_train <- sms_dtm[1:4169, ]
ssm_dtm_test <- sms_dtm[4170:5559, ]
